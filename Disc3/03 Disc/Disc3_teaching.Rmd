...
4.2 Find the probability that all 44 detectors are NOT defective.
...
$P(Smoke|Low) = \frac{P (Smoke and Low)}{P(Low)} =\frac{30/189}{59/189} = \frac{30}{59} = 0.5084746$
...
```{r, eval=TRUE}
WillFail <- c(rep(1,5), rep(0,95))
iterations <- 100000
CountFailed <- rep(0,iterations)

set.seed(1)
for (i in 1:iterations){
  samp <- sample(WillFail,3, replace=TRUE)
