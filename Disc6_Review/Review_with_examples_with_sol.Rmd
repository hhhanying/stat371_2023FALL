...
$(41*0 + 31*1 + 15*2 + 8*3 + 5*4)/100 = 1.05$
...
The original mean is $24$, which means the original total is $12*24 = 288$.

The new total is $288 - 11.9 + 1.19 = 277.79$.So, the mean is $277.29/12 = 23.1075$, so the mean decreased by $24 - 23.1075 = 0.8925$.
